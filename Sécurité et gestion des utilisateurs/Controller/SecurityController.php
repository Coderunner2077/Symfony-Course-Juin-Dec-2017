...
class SecurityController extends Controller {
	public function loginAction(Request $request) {
		...
		// Le service authentification_utils permet de récupérer le nom d'utilisateur et l'erreur dans le cas où le formulaire a déjà
		// été soumis mais était invalide (mauvais mot de passe par exemple)
